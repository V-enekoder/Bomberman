...
/**
 * La clase Servidor representa un servidor UDP que gestiona la conexión y
 * comunicación con los clientes.
 * Implementa la interfaz Runnable para ejecutar el servidor en un hilo
 * separado.
 */
...
public class Servidor implements Runnable {
     ...
     */
    private void analizarPacket(byte[] data, InetAddress address, int port) { // Yo tengo el tablero, solo debo mirar
                                                                              // ahí
