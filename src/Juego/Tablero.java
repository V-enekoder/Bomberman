...
/**
 * La clase Tablero representa el tablero de juego donde se desarrolla la
 * partida de Bomberman.
 * Contiene información sobre las celdas, jugadores, enemigos, bombas, mejoras y
 * explosiones.
 */
public class Tablero {
	 ...
	 * 
	 * @return Una lista de arreglos de enteros que representan las coordenadas de
	 *         las casillas reservadas.
	 */
	...
	/**
	 * Verifica si hay interacción entre un personaje y una casilla en particular en
	 * el tablero.
	 * 
	 ...
	 * Si el tiempo restante de una bomba llega a cero, se agrega a la lista de
	 * explosiones y se elimina de la lista de bombas.
	 * 
	 * @return Una colección de enteros que representa los índices de las bombas que
	 *         deben ser eliminadas de la lista de bombas.
	 */
	 ...
	 * Reduce la duración de las explosiones existentes y elimina aquellas cuya
	 * duración llega a cero.
	 * Para cada bomba que explota, determina las direcciones en las que se
	 * propagará la explosión y procesa cada celda afectada.
	 * 
	 */
	 ...
	 * Actualiza el estado de la celda en la posición dada y agrega una explosión en
	 * esa posición si no es una pared.
	 * Además, si la celda es un bloque, lo destruye y genera una nueva mejora en
	 * esa posición.
	 * Finalmente, reduce el tiempo restante de cualquier bomba que esté en esa
	 * posición a 1.
	 * 
	 * @param fila    La fila donde ocurrió la explosión.
	 * @param columna La columna donde ocurrió la explosión.
	 * @return true si la celda en la posición dada está abierta (no es una pared),
	...
	/**
	 * Genera una mejora en una posición específica del tablero dada por fila y
	 * columna.
	 * La mejora se elige aleatoriamente entre cuatro opciones y se agrega a la
	 * colección de mejoras.
	 * 
	 ...
	 * Reduce las vidas de los jugadores que se encuentren dentro del área de la
	 * explosión y que no estén inmunes.
	 * Si un jugador se queda sin vidas, aumenta el contador de partidas perdidas,
	 ...
	 * Si un jugador colisiona con un enemigo y no está inmune ni es un fantasma,
	 * reduce sus vidas.
	 * Si el jugador se queda sin vidas, envía un paquete de derrota al servidor,
	 * convierte al jugador en un fantasma
	...
	/**
	 * Comprueba si algún jugador ha chocado con una mejora y aplica la mejora al
	...
	/**
	 * Verifica si algún jugador ha salido del radio de explosión de una bomba y
	 * actualiza su estado.
	 */
	...
	/**
	 * Reduce el tiempo de inmunidad de los jugadores y los restaura si el tiempo de
	 * inmunidad llega a cero.
	 */
	...
	/**
	 * Verifica si algún jugador ha ganado la partida, es decir, si todos los
	 * jugadores, excepto uno, son fantasmas.
